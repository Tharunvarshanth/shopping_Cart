...
table tr td .add_to_cart{
  ...
  padding:5px;
    ...
    <div class="captionbar">
     ...
     <input type="text" id="searchid" name="searchbar" class="searchcls">
    ...
    <div id="myNav" class="overlay">
      ...
      <div class="overlay-content">
         ...
         <a href="http://localhost/shoppingcard/productview.php">Product List</a>
...
<?php 
     ...
     $sqlgetproductlist="select * from product where name LIKE '".$_GET["text"]."%' ;"  ;
           ...
           if($stmt->rowCount()>0) {
             ...
             while($row = $stmt->fetch(PDO::FETCH_ASSOC)){  
                ...
                ?>             
                  ...
                  <form method="post" action="productview.php?proid=<?php echo $row['id'] ?> ">
                  <tr >
                    <td>   
